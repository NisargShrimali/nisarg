...
class CRUD
{
    ...
    public function insert($first_name,$last_name,$email,$password,$conf_pass,$address,$phone_num,$gender,$hobbies,$country,$filename)
        {
            $ret = mysqli_query($this->con,"INSERT INTO user(first_name,last_name,email,password,conf_pass,address,phone_num,gender,hobbies,country,file)VALUES('$first_name','$last_name','$email','$password','$conf_pass','$address','$phone_num','$gender','$hobbies','$country','$filename')");
            return $ret;
        }

      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <!--begin::Header-->
            <div class="card-header"><div class="card-title"><h2>User-Form</h2></div></div>
                  <!--end::Header-->
                  <!--begin::Form-->
                    <!--begin::Body-->
              ...
              <div class="card-body">
                  ...
                  <div class="mb-3">
                      ...
                      <span class="text-danger"><?= $cpassError ?? '' ?></span>
                  </div>
                  ...
                  <div class="mb-3">
                      ...
                      <input type="text" name="phoneno" class="form-control" value="<?= htmlspecialchars($phoneno ?? '') ?>" />
                  ...
                  <div class="mb-3">
                      ...
                      <span class="text-danger"><?= $hobbiesError ?? '' ?></span>
                  </div>
                  <div class="mb-3">
                      <label>Country:-</label>
